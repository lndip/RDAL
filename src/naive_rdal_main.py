...
from naive_rdal_train_test import train_naive_rdal, test_naive_rdal
...
def main():
    ...
    grl_parameters, best_epoch = train_naive_rdal(batch_size=batch_size,
                                training=training,
                                do_grad_clip=False,
                                grad_clip_value=1,
                                patience=50, job_idx=job_idx, epochs=epochs, device=device)
    ...
    gender_ver_predictions, gender_ver_probs, gender_ver_acc_val, gender_ver_recall_val = test_naive_rdal(batch_size=batch_size,
                                    training=training,
                                    job_idx=job_idx,
                                    ver_epochs=epochs,
                                    ver_patience=50, 
