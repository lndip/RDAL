...
from rdal_mask_train_test import train_rdal_mask, test_rdal_mask
...
def main():
    ...
    grl_parameters, best_epoch = train_rdal_mask(batch_size=batch_size,
                        training=training,
                        do_grad_clip=True,
                        grad_clip_value=1,
                        P=P,
    ...
    gender_ver_predictions, gender_ver_probs, gender_ver_acc_val, gender_ver_recall_val = test_rdal_mask(batch_size=batch_size,
                                                                training=training,
                                                                job_idx=job_idx,
                                                                ver_epochs=epochs,
                                                                ver_patience=50, 
